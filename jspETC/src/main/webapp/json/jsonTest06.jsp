			...
			$.ajax({
				...
				success: function (data, textStatus){
					...
					for(let i in jsonInfo.books){
						bookInfo += "<hr/>";
						bookInfo += "<p>제목: "+jsonInfo.books[i].title+"</p>";
						bookInfo += "<p>저자: "+jsonInfo.books[i].writer+"</p>";
						imageURL = jsonInfo.books[i].image;
						bookInfo += "<img src=" + imageURL + " width='220' height='300'>";
					}
					$("#output").html(memInfo + bookInfo);
				},
...
<body>
	<input type="button" value="데이터 수신">
	<div id="output"></div>
